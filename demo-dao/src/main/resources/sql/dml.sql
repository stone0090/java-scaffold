...
MERGE INTO `jws_permission`(id, gmt_create, gmt_modified, permission_code, permission_name, permission_url) VALUES ('1', now(), now(), 'insert_user', '新增用户', '/demo/user/add'); -- REPLACE INTO
MERGE INTO `jws_permission`(id, gmt_create, gmt_modified, permission_code, permission_name, permission_url) VALUES ('2', now(), now(), 'delete_user', '删除用户', '/demo/user/remove'); -- REPLACE INTO
MERGE INTO `jws_permission`(id, gmt_create, gmt_modified, permission_code, permission_name, permission_url) VALUES ('3', now(), now(), 'update_user', '更新用户', '/demo/user/edit'); -- REPLACE INTO
MERGE INTO `jws_permission`(id, gmt_create, gmt_modified, permission_code, permission_name, permission_url) VALUES ('4', now(), now(), 'select_one_user', '查询单个用户', '/demo/user/get'); -- REPLACE INTO
MERGE INTO `jws_permission`(id, gmt_create, gmt_modified, permission_code, permission_name, permission_url) VALUES ('5', now(), now(), 'select_all_user', '查询全部用户', '/demo/user/list'); -- REPLACE INTO
